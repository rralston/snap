...
class ClipsControllerTest < ActionController::TestCase
  ...
  test "should create clip" do
    assert_difference('Clip.count') do
      post :create, clip: { date_string: @clip.date_string, location: @clip.location, speed: @clip.speed, time: @clip.time, video_url: @clip.video_url }
    end
  ...
  test "should update clip" do
    put :update, id: @clip, clip: { date_string: @clip.date_string, location: @clip.location, speed: @clip.speed, time: @clip.time, video_url: @clip.video_url }
    assert_redirected_to clip_path(assigns(:clip))
  end
